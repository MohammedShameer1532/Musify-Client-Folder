...
const OnboardAlbum = () => {
  ...
  return (
    <div className='p-4  w-[100%] h-[100%] overflow-hidden'
      ...
      {
        currentSong ? (
          <div className='rounded-lg w-[100%] h-[100%]  mt-[5rem] md:mt-[3rem] mb-[15rem] md:mb-[12rem] lg:mb-[12%]'
            style={{
            ...
            <div className="flex flex-col md:flex-row  items-center ">
              <div className="flex flex-col md:flex-row items-center  text-white">
                ...
                <div className='flex  ml-0 mt-0 overflow-hidden'>
            ...
            <div>
              {data ? (
                <div className="text-white ml-[-0.5rem] md:ml-0 p-4">
          ...
          <div className='rounded-lg w-[100%] h-[100%]  mt-[5rem] md:mt-[3rem] mb-[4rem] '
            style={{
              background: gradientColor,
              transition: 'background 0.5s ease'
            }} >

...
const Album = () => {
  ...
  return (
    <div className='p-4  w-[100%] h-[100%] overflow-hidden'
      ...
      {
        currentSong ? (
          <div className='rounded-lg w-[100%] h-[100%]  mt-[5rem] md:mt-[3rem] mb-[15rem] md:mb-[12rem]'
            style={{
            ...
            <div className="flex flex-col md:flex-row  items-center ">
              <div className="flex flex-col md:flex-row  items-center  text-white">
                ...
                <div className='flex flex-col ml-0 mt-0'>
                  <div className="font-medium text-xl md:text-5xl text-center md:text-start  text-white p-2">{data?.name}</div>
                  <div className='p-3 font-medium text-xl md:text-2xl whitespace-nowrap '> {data?.artists?.primary[0]?.name}</div>
                </div>
              </div>
            </div>
            <div>
              {data?.songs && data.songs.length > 0 ? (
                <div className="text-white ml-[-0.5rem] p-4">
                  <table className="min-w-full text-left  text-gray-400 mb-4">
                    <thead className="bg-gray-800 text-white text-xs md:text-sm font-semibold uppercase overflow-hidden">
                      <tr>
          ...
          </div>) : (<div className='rounded-lg w-[100%] h-[100%]  mt-[5rem] md:mt-[3rem] mb-[3rem] md:mb-[5rem]'
            style={{
              background: gradientColor,
              transition: 'background 0.5s ease'
            }}>
